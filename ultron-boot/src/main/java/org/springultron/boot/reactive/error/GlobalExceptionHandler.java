...
public class GlobalExceptionHandler {
    ...
    public Mono<ApiResult<Object>> handleCryptoException(CryptoException e) {
        ...
        return Mono.just(ApiResult.failed(ResultCode.SIGN_FAILED));
    }
    ...
    public Mono<ApiResult<Object>> handleAssertionError(AssertionError e) {
        ...
        // 发送：未知异常异常事件
        return Mono.just(ApiResult.failed(ResultCode.ASSERTION_ERROR.getCode(), e.getMessage()));
    }

    @ExceptionHandler(Throwable.class)
    public Mono<ApiResult<Object>> handleThrowable(Throwable e) {
        log.error("系统异常", e);
