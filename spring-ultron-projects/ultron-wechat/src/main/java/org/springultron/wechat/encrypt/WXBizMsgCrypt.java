...
public class WXBizMsgCrypt {
     ...
     * @return 消息签名
     */
    static String doSignature(String token, String timestamp, String nonce, String encrypt) {
        String[] strArray = new String[]{token, timestamp, nonce, encrypt};
        // 排序
    ...
    public String encryptMsg(String replyMsg, String timestamp, String nonce) throws AesException {
        ...
        // 生成安全签名
        String signature = doSignature(token, timestamp, nonce, encrypt);
        // System.out.println("发送给平台的签名是: " + signature);
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String decryptXmlMsg(String encryptedMsg, String msgSignature, String timestamp, String nonce) throws AesException {
        // 密钥，公众账号的app secret
        // 提取密文
        Object[] encrypt = XMLParse.extract(encryptedMsg);

        // 验证安全签名
        String signature = doSignature(token, timestamp, nonce, encrypt[1].toString());
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String decryptJsonMsg(String encryptedMsg, String msgSignature, String timestamp, String nonce) throws AesException {
        // 验证安全签名
        String signature = doSignature(token, timestamp, nonce, encryptedMsg);
